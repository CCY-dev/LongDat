...
```{r message=FALSE, tidy=TRUE, tidy.opts=list(width.cutoff=50)}
...
```
If you have complete running the function successfully, you'll see the message "Finished successfully!" at the end. 
