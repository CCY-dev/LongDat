...
#'         dependent variables).
#' @param data_type The data type of the dependent variable. Can either
#'  be "proportion", "measurement", "count", "binary", "ordinal" or "others".
...
#'
#'    OK but doubtful: There’s an effect of time and there’s no potential
#'     confounder, however the confidence interval of the test_var estimate
#'     in the model test covers zero, and thus it is doubtful of this signal.
#'
#'    OK and strictly deconfounded: There are potential confounders,
#'    however there’s an effect of time and it is independent of
#'    those of confounders.
#'
#'    Ambiguously deconfounded: There are potential confounders, and it isn’t
#'     possible to conclude whether the effect is resulted from time or
#'     confounders.
#'
#'    Confounded: There’s an effect of time, but it can be reduced to the
#'    confounder effects.
#'
