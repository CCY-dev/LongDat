...
fix_name_fun <- function(z) {
  ...
  n3 <- gsub(x = n2, pattern = "%", replacement = "percent", fixed = T)
  ...
  n13 <- gsub(x = n12, pattern = "+", replacement = "plus", fixed = T)
  n14 <- gsub(x = n13, pattern = "/", replacement = "_", fixed = T)
  n15 <- gsub(x = n14, pattern = "?", replacement = "QuestionMark", fixed = T)
  n16 <- gsub(x = n15, pattern = ",", replacement = "_", fixed = T)
  n17 <- gsub(x = n16, pattern = ">", replacement = "GreaterThan", fixed = T)
  n18 <- gsub(x = n17, pattern = "<", replacement = "LessThan", fixed = T)
