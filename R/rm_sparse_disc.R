#'Remove the dependent variables that are below the threshold
...
rm_sparse_disc <- function(values, data, nonzero_count_cutoff1,
  ...
  bac_exclude_2 <- subset(Ps_null_model,
                          non_zero_count <= nonzero_count_cutoff2)
